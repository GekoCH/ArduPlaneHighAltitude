...
const AP_Param::Info var_info[] PROGMEM = {
	...
	// @Param: fpv
    // @DisplayName: FPV Activate
    // @Description: In welchem Modus wird geflogen FPV =1 oder nicht =0
    // @Units: 0:Disabled,1:Enabled
    // @User: Advanced
    GSCALAR(fpv,          "FPV_ACTIVATE",  0),

	// @Param: BATTERY_EVENT_DRONE
    // @DisplayName: FBATTERY_EVENT_DRONE
    // @Description: In welchem Modus wird geflogen FPV =1 oder nicht =0
    // @Units: 0:Disabled,1:Enabled
    // @User: Advanced
    GSCALAR(DRONE_BATTERY_EVENT,          "DRONE_B_EVENT",  0),
	
    GSCALAR(release_altitude,          "DRONE_R_ALT",  RELEASE_ALTITUDE),

	GSCALAR(minimBattery,          "DRONE_min_batt",  15),

	GSCALAR(LM335offset,          "DRONE_LM335_off",  0),
