...
static int8_t       wp_einheit = 0;
static uint8_t      wp_number = 0; // Current waypoint number
static uint8_t      wp_no = 1; //am Anfang kein WP Pfeil
...
static uint8_t      osd_mode = 16;                   // Navigation mode from RC AC2 = CH5, APM = CH8
...
static float        osd_waypointDirection = 0;
