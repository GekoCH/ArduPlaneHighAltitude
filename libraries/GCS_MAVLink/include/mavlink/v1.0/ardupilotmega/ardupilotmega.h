...
enum MAV_CMD
{
	...
	//----------------------------------------------NEU-START--------------------------------------------------------------//
        MAV_CMD_RELAY_RELEASE=185,
        MAV_CMD_RELAY_RELEASE_PROHIBIT = 186,
        MAV_CMD_RELAY_LED_POSITION = 187,
		MAV_CMD_SET_HOME_ALT = 188,
		//MAV_CMD_SET_RELEASE_ALT = 189,
		MAV_CMD_SET_MIN_GND_SPEED = 190,
        //----------------------------------------------NEU-ENDE--------------------------------------------------------------//
